...
namespace Animal_Shelter.Migrations
{
    ...
    [Migration("20250920152035_AddOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animal_Shelter.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Animal_Shelter.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Animal_Shelter.Data.Entities.Order", b =>
                {
                    b.HasOne("Animal_Shelter.Data.Entities.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Animal_Shelter.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
